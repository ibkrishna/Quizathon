...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark" style="background: #000000;">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="enroll_exam.php">Assignments <i class="fas fa-book-open"></i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="profile.php">Profile <i class="fas fa-user" aria-hidden="true"></i></a>
        </li>
        <!--li class="nav-item">
          <a class="nav-link" href="change_password.php">Change Password <i class="fa fa-key" aria-hidden="true"></i></a>
        </li-->   
      </ul>
